...
client.on('guildMemberAdd', member => {
  member.guild.fetchInvites().then(guildInvites => {
    ...
    const logChannel = member.guild.channels.find(channel => channel.name === "typé");
...
client.on('guildMemberAdd', member => {
    ...
    const channel = member.guild.channels.find('name', 'typé');
...
if(message.content.startsWith("اسحب")) {
 ...
 return message.channel.send("**[mentions] اسحب**")
}
...
var embed = new Discord.RichEmbed()
 .setTitle("Succes!")
 .setColor("#000000")
 .setDescription(`:white_check_mark: **Done moved the member** <@${usermentioned}>`)
var embed = new Discord.RichEmbed()
.setDescription(`:white_check_mark: **Done moved the member** <@${usermentioned}>`)
 .setColor("#000000")
